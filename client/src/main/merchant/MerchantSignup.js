...
const MerchantSignup = () => {
            ...
            <div className="row">
                <div className="col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1 text-left">
                    <form>
                        ...
                        <button className="btn btn-info btn-block mt-3 rounded" onClick={onReset}>Reset </button>
                    </form>
                </div>
            </div>
        );
    ...
    const successMessage = () => (
        ...
        >
            ...
            <Link to="/restaurantsignin">Login Here</Link>
        </div>
        </div>
        </div>
    )
    ...
    return (
        <Base title="Restaurant Sign Up" description="A page for Restaurant to sign up">
            {signUpForm()}
            <br/>
            {successMessage()}
            {errorMessage()}
