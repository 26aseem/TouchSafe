...
import NewRestaurantPassword from "./merchant/NewRestaurantPassword"
import RestaurantReset from "./merchant/RestaurantReset"
    ...
    return(
        <Router>
            <Switch>
                ...
                <Route path="/restaurant/resetpassword" component={RestaurantReset}/>
                <Route path="/restaurant/updatepassword/:token" component={NewRestaurantPassword}/>
